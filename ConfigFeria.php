...
$(document).ready(function() {
	...
	"lengthMenu": "Mostrar _MENU_ Registros Ferias",
...
<div align="center" class="centro" style="width:800px;">
 ...
 <?php 
  ...
  $sql=$cn->prepare("SELECT * FROM feria");
  $sql->execute();
  ...
  while($op=$sql->fetch())	 	
   { ?>
    <tr bgcolor="#D7D7D7">
      <td height="63" class="Estilo26"><span class="Estilo33 Estilo1 Estilo4"><?php echo $op['codFeria'];?></span></td>
	  ...
	  <a href="EliminarFeria.php?id=<?php echo $op['codFeria'];?>"><img src="Imagenes/basura-icono-3648-48.png" width="26" height="25" /></a>
	  	  </td>
    </tr>  
    <?php  }  ?>
  </table>
