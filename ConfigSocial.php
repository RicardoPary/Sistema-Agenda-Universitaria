...
$(document).ready(function() {
	...
	"lengthMenu": "Mostrar _MENU_ Registros Eventos Sociales",
...
<div align="center" class="centro" style="width:800px;">
  ...
  <thead>
    <tr >
      ...
      <td width="130"><span class="Estilo15 Estilo1 Estilo4 Estilo5 Estilo6">Tipo</span></td>
      <td width="130"><span class="Estilo15 Estilo1 Estilo4 Estilo5 Estilo6">Cronograma</span></td>
 ...
 <?php 
  ...
  $sql=$cn->prepare("SELECT * FROM evento_social");
  $sql->execute();
  ...
  while($op=$sql->fetch())	 	
   { ?>
    <tr bgcolor="#D7D7D7">
      <td height="63" class="Estilo26"><span class="Estilo33 Estilo1 Estilo4"><?php echo $op['codeventoS'];?></span></td>
      ...
      <td class="Estilo26"><span class="Estilo33 Estilo1 Estilo4"><?php echo $op['tipo'];?></span></td>	  
      <td class="Estilo26"><span class="Estilo33 Estilo1 Estilo4"><?php echo $op['cronograma'];?></span></td>
      <td class="Estilo34 Estilo1 Estilo4">
	  
	  <a href="EliminarSocial.php?id=<?php echo $op['codeventoS'];?>"><img src="Imagenes/basura-icono-3648-48.png" width="26" height="25" /></a>
	 	  </td>
    </tr>  
    <?php  }  ?>
  </table>
