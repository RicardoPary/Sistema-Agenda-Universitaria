...
<div id="Menu1">
 ...
 <ul id="Menu">
    <li> <a href="inicio.php">Home</a></li> 
      <li> <a href="evenA.html">Eventos Academicos</a>
...
<tr>
       ...
       <td scope="row"><label for="label3">Codigo de Feria:</label></td>
  ...
  <fieldset>
  <legend><strong>Modificar Informacion De La Feria</strong></legend>
