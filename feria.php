...
<center>
  <form class="form" action="CrearFeria.php" method="post" enctype="multipart/form-data">

  <fieldset>
  <legend><strong>Formulario De La Feria</strong></legend>
  <table width="487" height="208" border="0" cellpadding="2" cellspacing="0">
   ...
   <tr>
       ...
       <td><input type="text" name="T5" id="password5" size="30" maxlength="32" /></td>
       <td>&nbsp;</td>   
   </tr>
   ...
   <tr>
       ...
       <td><input type="text" name="T6" id="password11" size="30" maxlength="32" /></td>
       <td>&nbsp;</td>
   </tr>
